...
# Created by write_sdc on Sun Sep 17 23:42:41 2023
...
set_input_delay -clock vclk  0  [get_ports {IP_word[21]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[20]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[19]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[18]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[17]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[16]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[15]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[14]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[13]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[12]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[11]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[10]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[9]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[8]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[7]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[6]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[5]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[4]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[3]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[2]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[1]}]
set_input_delay -clock vclk  0  [get_ports {IP_word[0]}]
...
set_input_delay -clock vclk  0  [get_ports IP]
set_output_delay -clock vclk  0  [get_ports {error_type_result[2]}]
...
set_input_transition -max 0.1  [get_ports {IP_word[21]}]
set_input_transition -min 0.1  [get_ports {IP_word[21]}]
set_input_transition -max 0.1  [get_ports {IP_word[20]}]
set_input_transition -min 0.1  [get_ports {IP_word[20]}]
set_input_transition -max 0.1  [get_ports {IP_word[19]}]
set_input_transition -min 0.1  [get_ports {IP_word[19]}]
set_input_transition -max 0.1  [get_ports {IP_word[18]}]
set_input_transition -min 0.1  [get_ports {IP_word[18]}]
set_input_transition -max 0.1  [get_ports {IP_word[17]}]
set_input_transition -min 0.1  [get_ports {IP_word[17]}]
set_input_transition -max 0.1  [get_ports {IP_word[16]}]
set_input_transition -min 0.1  [get_ports {IP_word[16]}]
set_input_transition -max 0.1  [get_ports {IP_word[15]}]
set_input_transition -min 0.1  [get_ports {IP_word[15]}]
set_input_transition -max 0.1  [get_ports {IP_word[14]}]
set_input_transition -min 0.1  [get_ports {IP_word[14]}]
set_input_transition -max 0.1  [get_ports {IP_word[13]}]
set_input_transition -min 0.1  [get_ports {IP_word[13]}]
set_input_transition -max 0.1  [get_ports {IP_word[12]}]
set_input_transition -min 0.1  [get_ports {IP_word[12]}]
set_input_transition -max 0.1  [get_ports {IP_word[11]}]
set_input_transition -min 0.1  [get_ports {IP_word[11]}]
set_input_transition -max 0.1  [get_ports {IP_word[10]}]
set_input_transition -min 0.1  [get_ports {IP_word[10]}]
set_input_transition -max 0.1  [get_ports {IP_word[9]}]
set_input_transition -min 0.1  [get_ports {IP_word[9]}]
set_input_transition -max 0.1  [get_ports {IP_word[8]}]
set_input_transition -min 0.1  [get_ports {IP_word[8]}]
set_input_transition -max 0.1  [get_ports {IP_word[7]}]
set_input_transition -min 0.1  [get_ports {IP_word[7]}]
set_input_transition -max 0.1  [get_ports {IP_word[6]}]
set_input_transition -min 0.1  [get_ports {IP_word[6]}]
set_input_transition -max 0.1  [get_ports {IP_word[5]}]
set_input_transition -min 0.1  [get_ports {IP_word[5]}]
set_input_transition -max 0.1  [get_ports {IP_word[4]}]
set_input_transition -min 0.1  [get_ports {IP_word[4]}]
set_input_transition -max 0.1  [get_ports {IP_word[3]}]
set_input_transition -min 0.1  [get_ports {IP_word[3]}]
set_input_transition -max 0.1  [get_ports {IP_word[2]}]
set_input_transition -min 0.1  [get_ports {IP_word[2]}]
set_input_transition -max 0.1  [get_ports {IP_word[1]}]
set_input_transition -min 0.1  [get_ports {IP_word[1]}]
set_input_transition -max 0.1  [get_ports {IP_word[0]}]
set_input_transition -min 0.1  [get_ports {IP_word[0]}]
...
set_input_transition -max 0.1  [get_ports IP]
set_input_transition -min 0.1  [get_ports IP]

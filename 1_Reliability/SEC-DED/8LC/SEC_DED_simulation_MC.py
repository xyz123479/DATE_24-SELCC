...
def correction_SEC_DED(codeword, syndrome, H_matrix) :
...
def main() :
    ...
    H_matrix = np.loadtxt("SEC_DED_H_matrix.txt", dtype = "int")
    ...
    for Nrun in range (0, MC_SIM_CNT) :
        ...
        corrected_codeword, nonzero, correctable = correction_SEC_DED(codeword, syndrome, H_matrix)
    ...
    # This is SEC-DED
    print("-----------------------------------------------------------")
    print(" SEC-DED with 64-bit data, 8-bit parity")
    print("-----------------------------------------------------------")
    ...
    for Nrun in range (0, MC_SIM_CNT) :
        ...
        # Decoding
        syndrome = make_syndrome(codeword, H_matrix)
        corrected_codeword, detectable, correctable = correction_SEC_DED(codeword, syndrome, H_matrix)
